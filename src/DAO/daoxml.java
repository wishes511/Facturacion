...
// # de Concepto
            ...
            for (int i = 0; i < f.getArr().size(); i++) {                       //      numero de renglones
                ...
                float unitario = Float.parseFloat(formateador.format(f.getArr().get(i).getPrecio()));
...
// - Fin numero ded concepto
            ...
            x.setTotalImpuesto(BigDecimal.valueOf((f.getImpuestos())).setScale(2, RoundingMode.HALF_UP));           //IMPUESTO TRASLADADO
