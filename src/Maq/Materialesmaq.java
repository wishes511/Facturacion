 ...
 * @author GATEWAY1-
 */
public class Materialesmaq extends javax.swing.JInternalFrame {
     ...
     * @param u
     */
    public Materialesmaq(Conexiones c, Usuarios u) {
        initComponents();
        cpt = c.getCpttpu();
        rcpt = c.getRcpttpu();
    ...
    private void jLabel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MousePressed
        Nuevomaterialmaq n = new Nuevomaterialmaq(null, true);
        n.cpt = cpt;
        n.rcpt = rcpt;
        n.litecfdi = litecfdi;
        n.setVisible(true);
    ...
    private void setrows() {
        ...
        arrmat = dm.getmaterialesmaq(cpt, JtMaterial.getText().toUpperCase());
        settable();
    }
