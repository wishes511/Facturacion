 ...
 */
public class Devolucionestpu extends javax.swing.JInternalFrame {
     ...
     * datos de usuario
     */
    public Devolucionestpu(Conexiones cn, Usuarios usu) {
        initComponents();
        cpt = cn.getCpttpu();
        rcpt = cn.getRcpttpu();
    ...
    private void conexiones() {//Conexiones a servidor
        try {
            ...
            Logger.getLogger(Devolucionestpu.class.getName()).log(Level.SEVERE, null, ex);
...
//        c1.cobB=cobB;
    ...
    public final void generaciontab() {//generar tabs
        c1 = new devstpu();
        Tabbed.addTab("Listado de Devoluciones", c1);
