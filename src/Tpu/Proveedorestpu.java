 ...
 * @author GATEWAY1-
 */
public class Proveedorestpu extends javax.swing.JInternalFrame {

    Connection cpt, rcpt, cobranza;
    Connection litecfdi;
    ArrayList<ProveedorMPrima> arrprov = new ArrayList<>();
     ...
     * @param u
     */
    public Proveedorestpu(Conexiones c, Usuarios u) {
        initComponents();
        cpt = c.getCpttpu();
        rcpt = c.getRcpttpu();
    ...
    private void setrows() {
        ...
        arrprov = p.getallprov(cpt, JtMaterial.getText());
        settable();
    }
    ...
    private void settable() {
        ...
        model.setNumRows(arrprov.size());
        for (int i = 0; i < arrprov.size(); i++) {
            String estado = (arrprov.get(i).getEstatus().equals("1")) ? "Activo" : "Inactivo";
            model.setValueAt(arrprov.get(i).getNombre(), i, 0);
            model.setValueAt(arrprov.get(i).getRfc(), i, 1);
            model.setValueAt(arrprov.get(i).getCp(), i, 2);
            model.setValueAt(arrprov.get(i).getRazons(), i, 3);
            model.setValueAt(arrprov.get(i).getPais(), i, 4);
    ...
    private void JtDetalleMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtDetalleMousePressed
        String estado = arrprov.get(JtDetalle.getSelectedRow()).getEstatus();
        if (estado.equals("1")) {
    ...
    private void cambiaestado() {
        String estado = (arrprov.get(JtDetalle.getSelectedRow()).getEstatus().equals("1")) ? "0" : "1";
        int id = arrprov.get(JtDetalle.getSelectedRow()).getProveedor();
