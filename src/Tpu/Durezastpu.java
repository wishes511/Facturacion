 ...
 * @author GATEWAY1-
 */
public class Durezastpu extends javax.swing.JInternalFrame {
     ...
     * @param u
     */
    public Durezastpu(Conexiones c, Usuarios u) {
        initComponents();
        cpt = c.getCpttpu();
        rcpt = c.getRcpttpu();
    ...
    private void jLabel1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MousePressed
        Nuevadurez n = new Nuevadurez(null, true);
        n.cpt = cpt;
        n.setVisible(true);
        setrows();
    ...
    private void settable() {
        ...
        model.addColumn("Dureza");
        model.addColumn("Estado");
        model.setNumRows(arrdureza.size());
        for (int i = 0; i < arrdureza.size(); i++) {
            String estado = (arrdureza.get(i).getEstatus().equals("1")) ? "Activo" : "Inactivo";
            model.setValueAt(arrdureza.get(i).getDureza(), i, 0);
    ...
    private void JtDetalleMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtDetalleMousePressed
        String estado = arrdureza.get(JtDetalle.getSelectedRow()).getEstatus();
        if (estado.equals("1")) {
    ...
    private void cambiaestado() {
        String estado = (arrdureza.get(JtDetalle.getSelectedRow()).getEstatus().equals("1")) ? "0" : "1";
        String id = arrdureza.get(JtDetalle.getSelectedRow()).getDureza();
        daodurezas d = new daodurezas();
