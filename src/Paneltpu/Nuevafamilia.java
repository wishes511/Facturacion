 ...
 * @author GATEWAY1-
 */
public class Nuevafamilia extends javax.swing.JDialog {
     ...
     */
    public Nuevafamilia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Capturar nueva Familia");
    ...
    private void setfamilia() {
        ...
        if (nombre.isEmpty()) {
            ...
            f.setDescripcion(nombre);
            daofamilias d = new daofamilias();
            if (d.newfamilia(cpt, f)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nuevafamilia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Nuevafamilia dialog = new Nuevafamilia(new javax.swing.JFrame(), true);
